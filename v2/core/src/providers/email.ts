...
export interface EmailConfig {
  theme: any
  pages: ProviderPages
  getEmail?: (request: AponiaAuth.InternalRequest) => Awaitable<string | Nullish>
  onAuth?: (request: AponiaAuth.InternalRequest, args: any) => Awaitable<AponiaAuth.InternalResponse | Nullish>
  onVerify?: (request: AponiaAuth.InternalRequest, args: any) => Awaitable<AponiaAuth.InternalResponse | Nullish>
}
