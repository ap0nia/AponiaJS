...
export const GitHub = (options: OAuthUserConfig<GitHubProfile>): OAuthProvider<GitHubProfile> => {
  return new OAuthProvider<GitHubProfile>(mergeOAuthOptions(options, GitHubOptions))
}
