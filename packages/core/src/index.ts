 ...
 */
type AuthCallbacks = {
  [k in keyof AuthPages]?: (request: Aponia.InternalRequest) => Awaitable<Aponia.InternalResponse | Nullish>
}
...
export class Auth {
   ...
   */
  async generateInternalResponse(internalRequest: Aponia.InternalRequest): Promise<Aponia.InternalResponse> {
