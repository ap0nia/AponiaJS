...
/**
 * See more at:
 * [Retrieve the User's Information from Apple ID Servers](https://developer.apple.com/documentation/sign_in_with_apple/sign_in_with_apple_rest_api/authenticating_users_with_sign_in_with_apple#3383773)
 */
...
export interface AppleOptions<P extends AppleProfile> extends Omit<OAuthUserConfig<P>, "clientSecret"> {
  /**
   * Apple requires the client secret to be a JWT. 
   * You can generate one using the following script: https://bal.so/apple-gen-secret
   * 
   * Read more: [Creating the Client Secret](https://developer.apple.com/documentation/sign_in_with_apple/generate_and_validate_tokens#3262048)
   */
  clientSecret: string
}

function Apple<P extends AppleProfile>(options: AppleOptions<P>): OAuthConfig<P> {
  return {
    id: "apple",
    name: "Apple",
    type: "oidc",
